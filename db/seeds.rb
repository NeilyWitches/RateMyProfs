...
demo_user = User.create(email: 'demouser@demo.com', first_name: 'Demo User', last_name: 'Demo User')
demo_user.password=('cupcake')
demo_user.save!

neil = Prof.create(first_name: 'Neil', last_name: 'Pandya', subject: 'Physics')
george = Prof.create(first_name: 'George', last_name: 'Haramuniz', subject: 'Mathematics')
greg = Prof.create(first_name: 'Greg', last_name: 'Sabin', subject: 'Management')
...
And then some!", klass: 'PHY185', grade: 'Rather not say', prof_id: 1)
...
your best effort should be exerted.", klass: 'PHY185', grade: 'A+', prof_id: 1)
...
class.", klass: 'MAT040', grade: 'Not sure yet', prof_id: 2)
...
klass: 'MGMTE2000', grade: 'A-', prof_id: 3)
